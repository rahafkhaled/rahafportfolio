    ...
    <WindowTemplate>
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center gap-4 md:gap-16 z-10 flex-wrap px-4">
            <motion.button
              onClick={() => scrollToSection(heroRef)}
              className={`px-3 md:px-6 py-2 md:py-3 text-sm md:text-lg font-medium transition-colors ${activeSection === "hero" ? "text-white" : "text-gray-400 hover:text-white"}`}
            ...
            <motion.button
              ...
              className="px-3 md:px-6 py-2 md:py-3 text-sm md:text-lg font-medium transition-colors text-gray-400 hover:text-white"
              whileHover={{ scale: 1.08 }}
              whileTap={{ scale: 0.96 }}
            >
              Events Gallery
        ...
        <section
          ref={heroRef}
          className="relative text-white flex items-center justify-center py-12 md:py-20 px-4"
        >
          ...
          <div className="relative flex items-center justify-center w-full">
            <div className="container mx-auto px-4 md:px-8">
              <div className="flex flex-col items-center justify-center text-center space-y-6 md:space-y-8 w-full">
                <motion.div
    ...
    `
                ...
                >
                  ...
                  <p className="text-base md:text-lg font-normal leading-relaxed text-purple-100/90 px-4 md:px-0">
                    ...
                    through the noise to find what's relevant, impactful, and <br />
        ...
        <section
          ref={servicesRef}
          className="py-5 px-4 md:px-8 relative text-white mb-14"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
              {services.map((service, index) => (
                <motion.div
                  ...
                  className="bg-white/10 shadow-lg backdrop-blur-lg rounded-xl p-6 md:p-10 border border-purple-400/20 relative overflow-hidden group hover:bg-white/20 transition-all duration-300"
                  whileHover={{
                    y: -5,
                    boxShadow:
                ...
                >
                  ...
                  <img
                    src={service.img}
                    alt={service.title}
                    className="w-full h-32 md:h-40 object-cover rounded-lg shadow mb-4"
                  />
                  <p className="text-purple-200/80 text-sm md:text-lg leading-relaxed md:leading-[2]">
                    {service.description}
                  </p>
                </motion.div>
              ))}
        ...
        <section className="py-8 md:py-12 px-4 md:px-6 relative text-white mb-14">
          <div className="container mx-auto flex flex-col items-center justify-center text-center">
            ...
            <div className="w-full max-w-4xl mx-auto mb-8 md:mb-12">
              <div className="bg-white/10 shadow-lg backdrop-blur-lg rounded-2xl border border-purple-400/20 flex flex-col md:flex-row overflow-hidden hover:bg-white/20 transition-all duration-300">
                ...
                {/* Content */}
                <div className="flex-1 flex flex-col justify-between p-6 md:p-8 text-left relative">
                  <div>
                    <h3
                    ...
                    <p className="text-purple-100 text-sm md:text-lg leading-relaxed mb-6 md:mb-8">
                  ...
                  <div className="flex justify-end items-end w-full mt-auto">
                    <motion.a
                      ...
                      className="inline-flex items-center gap-2 px-6 md:px-8 py-2 md:py-3 rounded-full bg-white/10 border border-purple-400/40 text-purple-200 font-semibold shadow-lg hover:bg-white/20 transition-all text-sm md:text-base"
                    >
                      <span className="i-fa-solid:download text-base md:text-lg" />
                      Download Report
                    </motion.a>
                  </div>
                </div>
        ...
        <section
          ref={contactRef}
          className="pt-6 md:pt-8 pb-10 md:pb-14 px-4 md:px-8 relative text-white"
        >
          <div className="container mx-auto flex flex-col items-center justify-center text-center">
            <h2
              className="mb-4"
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="flex justify-center space-x-6 md:space-x-8 mb-6 md:mb-8"
            >
              <motion.a
              ...
              <motion.a
                ...
                className="size-12 md:size-14 flex items-center justify-center rounded-full bg-white/10 border border-purple-400/40 text-purple-200 hover:bg-white/20 transition-all shadow-lg backdrop-blur-lg relative"
              >
                <span className="i-simple-icons:substack text-xl md:text-2xl z-10" />
                <span
                  className="absolute inset-0 rounded-full pointer-events-none"
                  style={{ boxShadow: "0 0 12px 2px #a855f744", opacity: 0.5 }}
                />
            ...
            <motion.button
              ...
              className="mt-4 px-6 md:px-8 py-2 md:py-3 rounded-full bg-white/10 border border-purple-400/20 text-purple-200 font-semibold shadow-lg hover:bg-white/20 transition text-sm md:text-base"
              onClick={() => openApp && openApp("contact")}
            >
              Send me a message
            </motion.button>
