...
declare global {
  ...
  const AppleNotification: typeof import('./components/AppleNotification')['default']
  ...
  const FileIcon: typeof import('./components/FileIcon')['default']
  const FileIcons: typeof import('./components/FileIcons')['default']
  const Launchpad: typeof import('./components/Launchpad')['default']
  const Library: typeof import('./components/apps/Library')['default']
  ...
  const NavIconAbout: typeof import('./components/PortfolioMobileNavIcons')['NavIconAbout']
  const NavIconContact: typeof import('./components/PortfolioMobileNavIcons')['NavIconContact']
  const NavIconGallery: typeof import('./components/PortfolioMobileNavIcons')['NavIconGallery']
  const NavIconNews: typeof import('./components/PortfolioMobileNavIcons')['NavIconNews']
  const NavIconReleases: typeof import('./components/PortfolioMobileNavIcons')['NavIconReleases']
  const NavIconResume: typeof import('./components/PortfolioMobileNavIcons')['NavIconResume']
  ...
  const WindowTemplate: typeof import('./components/WindowTemplate')['default']
